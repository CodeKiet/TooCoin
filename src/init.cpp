...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: toocoin.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: toocoind.pid)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. TooCoin is probably already running."), strDataDir.c_str()));
