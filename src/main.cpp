...
// Copyright (c) 2014 The TooCoin developers
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TooCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TooCoinMiner : ProcessBlock, block not accepted");
    }
...
void static ThreadBitcoinMiner(CWallet *pwallet)
{
    ...
    {
        printf("TooCoin miner terminated\n");
        throw;
    }
}
