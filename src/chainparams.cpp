...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("seed1.toocoin.org", "seed1.toocoin.org"));
        vSeeds.push_back(CDNSSeedData("seed2.toocoin.org", "seed2.toocoin.org"));
        vSeeds.push_back(CDNSSeedData("seed3.toocoin.org", "seed3.toocoin.org"));
        vSeeds.push_back(CDNSSeedData("seed4.toocoin.org", "seed4.toocoin.org"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testseed1.toocoin.org", "testseed1.toocoin.org"));
